...
**jamovi Location:** `JJStatsPlot` -\> `Categorical vs Continuous` -\>
...
**jamovi Location:** `JJStatsPlot` -\> `Categorical vs Categorical` -\>
`Bar Charts`
...
**jamovi Location:** `JJStatsPlot` -\> `Continuous vs Continuous` -\>
`Scatter Plot`
