...
capabilities using oncology datasets from the `OncoDataSets` package.
We’ll create publication-ready statistical plots that combine beautiful
visualizations with rigorous statistical testing.
...
The jjstatsplot module transforms statistical analysis into
publication-ready visualizations by:
...
Used with `OncoDataSets`, researchers can quickly create compelling
visualizations that effectively communicate their findings while
...
- ggstatsplot (underlying package):
