...
This quick reference provides essential information for using
jjstatsplot efficiently in both jamovi and R.

### Function Overview

| Function | Purpose | Data Type | jamovi Location |
|----|----|----|----|
| [`jjhistostats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjhistostats.md) | Distribution analysis | 1 continuous | Continuous → Histogram |
| [`jjscatterstats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjscatterstats.md) | Bivariate relationships | 2 continuous | Continuous vs Continuous → Scatter Plot |
| [`jjcorrmat()`](https://www.serdarbalci.com/jjstatsplot/reference/jjcorrmat.md) | Multiple correlations | 2+ continuous | Continuous vs Continuous → Correlation Matrix |
| [`jjbetweenstats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjbetweenstats.md) | Group comparisons | 1 continuous + 1 categorical | Categorical vs Continuous → Box-Violin (Between) |
| [`jjdotplotstats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjdotplotstats.md) | Group means | 1 continuous + 1 categorical | Categorical vs Continuous → Dot Chart |
| [`jjwithinstats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjwithinstats.md) | Paired comparisons | 2+ continuous (paired) | Categorical vs Continuous → Box-Violin (Within) |
| [`jjbarstats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjbarstats.md) | Categorical associations | 1-2 categorical | Categorical vs Categorical → Bar Charts |
| [`jjpiestats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjpiestats.md) | Proportional data | 1 categorical | Categorical vs Categorical → Pie Charts |
...
|----|----|----|
| [`jjhistostats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjhistostats.md) | Shapiro-Wilk normality | Anderson-Darling, Kolmogorov-Smirnov |
| [`jjscatterstats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjscatterstats.md) | Pearson correlation | Spearman, robust correlation |
| [`jjbetweenstats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjbetweenstats.md) | Welch’s ANOVA | Student’s t-test, Kruskal-Wallis |
| [`jjdotplotstats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjdotplotstats.md) | Similar to between-stats | Non-parametric alternatives |
| [`jjwithinstats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjwithinstats.md) | Paired t-test | Wilcoxon signed-rank |
| [`jjbarstats()`](https://www.serdarbalci.com/jjstatsplot/reference/jjbarstats.md) | Chi-square test | Fisher’s exact test |
| [`jjcorrmat()`](https://www.serdarbalci.com/jjstatsplot/reference/jjcorrmat.md) | Pearson correlations | Spearman, partial correlations |
...
- Memory problems: Clean workspace with
...
Example: “A Welch’s ANOVA revealed a significant difference in fuel
efficiency across cylinder groups, F(2, 18.03) = 39.70, p \< .001, η² =
.70, suggesting a large effect.”
...
- GitHub:
  [sbalci/ClinicoPathJamoviModule/issues](https://github.com/sbalci/ClinicoPathJamoviModule/issues)
- Email: <serdarbalci@serdarbalci.com>

This quick reference covers the essentials for efficient jjstatsplot
usage. For detailed examples and advanced usage, consult the
comprehensive vignettes listed above.
