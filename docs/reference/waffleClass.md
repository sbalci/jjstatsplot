...
The function produces a waffle chart.

## Super classes

[`jmvcore::Analysis`](https://rdrr.io/pkg/jmvcore/man/Analysis.html) -\>
`jjstatsplot::waffleBase` -\> `waffleClass`

## Methods

### Public methods

- [`waffleClass$clone()`](#method-waffleClass-clone)
...
- [`jjstatsplot::waffleBase$initialize()`](https://www.serdarbalci.com/jjstatsplot/reference/waffleBase.html#method-initialize)
